...
![Fancy Swing Dialog](docs/screenshots/Screenshot from 2025-12-24 13-17-42.png)
*RunningJVM: Fancy swing dialog generated by gemini-3-flash-preview*

![Context Heatmap](docs/screenshots/Screenshot from 2025-12-24 13-12-31.png)
*Gain full transparency with the Context Heatmap, visualizing the AI's real-time understanding of your workspace.*

![Anahata DJ Tool](docs/screenshots/Screenshot from 2025-12-24 13-16-19.png)
*Beyond code: Anahata managing complex, multi-threaded media tools like the integrated DJ Engine.*

![Tool Execution & Code Suggestion](docs/screenshots/Screenshot from 2025-12-24 12-17-53.png)
*Watch Anahata execute IDE actions and propose intelligent code changes via secure diff dialogs.*

![Refactoring in Action](docs/screenshots/Screenshot from 2025-12-24 12-17-44.png)
*Anahata leverages NetBeans' native refactoring capabilities for safe and efficient code modifications.*

![Project Awareness](docs/screenshots/Screenshot from 2025-12-24 12-17-37.png)
*Anahata understands your entire project structure, from source files to complex dependencies.*

![Output Window Interaction](docs/screenshots/Screenshot from 2025-12-24 12-16-13.png)
*Deeply integrated: Interacting with and analyzing the NetBeans Output Window in real-time.*

![Anahata Session Management](docs/screenshots/Screenshot from 2025-12-24 12-11-22.png)
*Manage your AI sessions with ease, saving and loading full conversation states.*

![Anahata Context Providers](docs/screenshots/Screenshot from 2025-12-24 12-16-40.png)
*Explore the real-time data streams feeding Anahata's intelligence via dynamic Context Providers.*

![Anahata Tool Permissions](docs/screenshots/Screenshot from 2025-12-24 12-37-36.png)
*Granular security: Configure tool execution permissions (Always, Prompt, Never) to suit your workflow.*
